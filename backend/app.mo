...
actor {
  ...
  public func getLatestReports() : async [Types.Report] {
    return await Report.getLatestReports(reports);
  };
  ...
  public shared (msg) func updateUser(email : ?Text, username : ?Text, pictureCid : ?Text) : async {
    success : Bool;
    error : ?Text;
  } {
